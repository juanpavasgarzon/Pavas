...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20250105054644_Movements")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.MeasurementUnits.MeasurementUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Symbol")
                        .IsUnique()
                        .HasDatabaseName("ix_measurement_units_symbol");

                    b.ToTable("measurement_units", "public");
                });
            ...
            modelBuilder.Entity("Domain.Movements.MovementProduct", b =>
                {
                    ...
                    b.HasKey("MovementId", "ProductId")
                        .HasName("pk_movement_products");

                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_movement_products_product_id");

                    b.ToTable("movement_products", "public");
                });
            ...
            modelBuilder.Entity("Domain.Movements.MovementProduct", b =>
                {
                    b.HasOne("Domain.Movements.Movement", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_movement_products_movements_movement_id");
                    ...
                    b.HasOne("Domain.Products.Product", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_movement_products_products_product_id");
                });
